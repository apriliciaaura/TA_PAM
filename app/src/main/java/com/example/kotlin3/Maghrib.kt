...
class Maghrib : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        simpan.setOnClickListener{
            ...
            var data_waktumaghrib = waktumaghrib.text.toString()

            postkeserver(data_waktumaghrib)
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) { // do anything with response
                    ...
                    for (i in 0 until jsonArray.length()){
                        ...
                        waktu_maghrib.setText(jsonObject.optString("maghrib"))
                    }
                }
    ...
    fun postkeserver(data1:String){
        ...
        AndroidNetworking.post("http://10.35.150.94/sholat/maghrib-proses.php")
