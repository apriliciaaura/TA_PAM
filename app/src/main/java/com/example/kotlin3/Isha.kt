...
import kotlinx.android.synthetic.main.activity_isha.*
...
class Isha : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        simpan.setOnClickListener{
            ...
            var data_waktuisha = waktuisha.text.toString()

            postkeserver(data_waktuisha)
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) { // do anything with response
                    ...
                    for (i in 0 until jsonArray.length()){
                        ...
                        waktu_isha.setText(jsonObject.optString("isha"))
                    }
                }
    ...
    fun postkeserver(data1:String){
        ...
        AndroidNetworking.post("http://10.35.150.94/sholat/isha-proses.php")
